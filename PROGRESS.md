...
อัปเดตล่าสุด: 2026-08-30 (**M27 หน้าลองเลือกทิศ UX/UI ใหม่ทั้งเว็บ — รอเบสเคาะ · branch `proto/redesign-2026`**)
...
## ▶ NEXT (ทำต่อทันที)
0. **รอเบสเคาะทิศจากหน้าลอง `/proto/redesign-2026`** (ปัจจุบัน / A ตาราง / B ถามตอบ / C คู่มือ) → เคาะแล้วค่อยลงของจริงทั้งเว็บ + อัปเดตทะเบียนหน้าลองเป็น "เคาะแล้ว"
0b. **ฐานข้อมูลหาย — ต้องเบสตัดสิน**: สร้าง Supabase ใหม่แล้ว seed คืน (seed script ครบใน `prisma/`) หรือย้ายผู้ให้บริการ · จนกว่าจะแก้ เว็บจริงเปิดไม่ได้ (หน้าลองยังเปิดได้ปกติ)
