...
อัปเดตล่าสุด: 2026-08-30 (**M29 หน้าลองรอบ 3 "แบรนด์เป็นทางเข้า + ลุคสว่าง" — รอเบสเคาะ · branch `proto/redesign-2026`**)
...
## ▶ NEXT (ทำต่อทันที)
0. **รอเบสเคาะจากหน้าลองรอบ 3 `/proto/brand-first`** (G ANALYTICS / H BLUEPRINT — ผสมได้) → เคาะแล้วลงของจริงทั้งเว็บ
