...
- **ตาราง = tracker density ในโทน minimal เดิม (เบสเลือก T3 จากหน้าเทียบ 3 ระดับ op.gg-style 2026-07-20):** แถวเตี้ย (py-2) · รูปรถ 56×32 · ชื่อรุ่น semibold บรรทัดบน + แบรนด์จางบรรทัดล่าง · **PriceBar** ใต้ราคา (bar สีเดียว `bg-accent/70` บนราง surface-muted · สเกลนิ่งจากราคาแพงสุดทั้ง coverage ไม่ขยับตาม filter · เป็น data-viz ราคา ไม่ใช่ ranking) — เบส reject T1 (op.gg เต็มตัว ตัด hero) และ T2 (panel dashboard) แล้ว อย่าดันไปทางนั้นอีกโดยไม่ถาม
