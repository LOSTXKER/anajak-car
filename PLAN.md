...
## ✅ Milestone 19: เกลาตารางหน้าแรกตามฟีดแบ็กจริง 2 รอบ (เสร็จ 2026-07-20)
- [x] รอบ 1 ("รก/ตัวเล็ก/ไม่เป็นระเบียบ/หลอดราคาไว้ทำไม"): ตัดหลอดราคา · ราคาแถวสรุป = "เริ่มต้น" ตัวเดียว · ตัดของซ้ำรายแถว (แบรนด์/ปี/วันที่→ยกขึ้นพูดครั้งเดียว) · ประเภทบรรทัดเดียว · ตัวหนังสือ ≥14px/13px
- [x] รอบ 2 ("ไม่ต้องมีรุ่นย่อยในหน้าแรกเลย"): ตัดระบบกดกางทิ้ง — แถวรุ่นคลิกเข้าหน้ารายละเอียด (บันไดราคาแสดงรุ่นย่อยที่เดียว) · คอลัมน์ท้าย "x รุ่นย่อย ›" · ค้นหายังครอบชื่อรุ่นย่อย
