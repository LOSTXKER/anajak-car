...
// 404 ในโซน app — navbar มาจาก (app)/layout · ใส่ footer ผ่าน AppShell (ไม่มี sidebar)
  ...
  return (
    <AppShell>
      <div className="mx-auto flex w-full max-w-6xl flex-col items-center px-4 py-32 text-center sm:px-6">
        ...
        <Link href="/" className="mt-6 rounded-full bg-foreground px-5 py-2.5 text-sm font-medium text-background transition-opacity hover:opacity-85">
          กลับไปหน้าฐานข้อมูล
        </Link>
      </div>
    </AppShell>
